...
r = 5 # penalty factor
max_iter_num = 1000 # max number of iterations
...
plt.plot(index_list, policy_list[:,0], label = 'mu_0')
plt.plot(index_list, policy_list[:,1], label = 'mu_1')
plt.plot(index_list, [opt_sol[0]]*len(index_list), linestyle="--",label = 'opt_mu_0' )
plt.plot(index_list, [opt_sol[1]]*len(index_list), linestyle="--",label = 'opt_mu_1' )
plt.legend()
plt.show()
